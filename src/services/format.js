...
module.exports.handleAsyncRequest = async (execution) => {
    ...
    if (response && response.erorr){
        ...
        throw new ServerError('Server error! Could not complete the request due to due unknown error.');
    }
    return response
}
...
module.exports.handleReassignField = (record, currentFieldName, newFieldName) => {
